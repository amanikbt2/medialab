            ...
            body.innerHTML = `
              <div class="grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
                <div class="rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-4">
                  ...
                  <div class="mt-4 overflow-hidden rounded-[1.25rem] border border-white/10 bg-white">
                    <iframe srcdoc="${escapeHtml(data.item.sourceHtml || "<!DOCTYPE html><html><body><p>No preview available.</p></body></html>")}" class="block h-[420px] w-full bg-white"></iframe>
                  </div>
                </div>
                <div class="space-y-4">
                  <div class="rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-4">
